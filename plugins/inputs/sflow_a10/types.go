...
func (c *CounterData) GetTags(ipDimensions []IPDimension, portDimension *PortDimension) map[string]string {
	tags := make(map[string]string)

	tags["table_type"] = portDimension.TableType
	tags["port_number"] = fmt.Sprint(portDimension.PortNumber)
	tags["port_type"] = portDimension.PortType
	tags["port_range_end"] = fmt.Sprint(portDimension.PortRangeEnd)
